<template>
  <div class="container container--centered">
    <form action="#" class="urlform" @submit.prevent="shortenUrl" novalidate>
      <input type="url" placeholder="Let's get you a shorter url..." class="urlform__input" v-model="formUrl"></input>
    </form>
    ...
    <transition enter-active-class="animate animate--grow">
      <div class="result" v-if="shortened">
        ...
        <button class="button button__yellow" id="copy" data-clipboard-target="#url">Copy to clipboard</button>
      </div>
    </transition>
